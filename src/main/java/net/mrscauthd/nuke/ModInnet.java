...
import net.mrscauthd.nuke.itemgroups.NukeTab;
...
public class ModInnet {
    ...
    public static final DeferredRegister<EntityType<?>> ENTITYS = DeferredRegister.create(ForgeRegistries.ENTITIES, "nuke");
    ...
    public static RegistryObject<Item> NUKE_ITEM = ITEMS.register("nuke",() -> new BlockItem(ModInnet.NUKE_BLOCK.get(),new Item.Properties().tab(NukeTab.nuke_tab)));
